...
#### Note: To run the app you have to add [NewsAPI.org](https://newsapi.org/register) key. I have taken this step due to limited access to daily request for News. Getting a key would take just few seconds :)
