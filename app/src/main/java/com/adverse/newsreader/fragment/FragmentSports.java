...
public class FragmentSports extends Fragment implements OnRecyclerViewItemClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Call<ResponseModel> call = apiService.getLatestNewsCategory("in", "sports", ApiClient.API_KEY);
                ...
                try {
                    if (response.body().getStatus().equals("ok")) {
                        ...
                        if (articleList.size() > 0) {
                            ...
                            mainArticleAdapter.setOnRecyclerViewItemClickListener(FragmentSports.this);
