...
public class FragmentHealthFitness extends Fragment implements OnRecyclerViewItemClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Call<ResponseModel> call = apiService.getLatestNewsCategory("in", "health", ApiClient.API_KEY);
              ...
              try {
                  if (response.body().getStatus().equals("ok")) {
                      ...
                      if (articleList.size() > 0) {
                          ...
                          mainArticleAdapter.setOnRecyclerViewItemClickListener(FragmentHealthFitness.this);
                          recyclerView.setAdapter(mainArticleAdapter);
                          progressDialog.dismiss();
                          getActivity().setTitle("Health & Fitness");
                      }
                  }
              } catch (Exception e){
                  e.printStackTrace();
